...
// Indian seasonal produce — reflects monsoon / early autumn availability.
// Labeled as illustrative; not date-aware or live.
const SEASONAL = [
  { name: 'sweet corn',      label: 'In season' },  // monsoon crop
  { name: 'guava',           label: 'In season' },  // monsoon–winter
  { name: 'pomegranate',     label: 'In season' },  // early autumn
  { name: 'fresh ginger',    label: 'In season' },  // monsoon harvest
  { name: 'green chillies',  label: 'In season' },  // peak monsoon
];
