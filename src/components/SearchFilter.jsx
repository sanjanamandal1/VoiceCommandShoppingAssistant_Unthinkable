...
import { searchProducts, ALL_BRANDS } from '../lib/mockProducts.js';

export default function SearchFilter({ onVoiceSearch, voiceQuery }) {
  ...
  const results = showResults || voiceQuery
  ...
  return (
    <section className="search-filter" aria-label="Search products">
      <h2 className="search-filter__heading">
        Search catalog
        <span className="search-filter__badge">Mock data — 18 products</span>
      </h2>
